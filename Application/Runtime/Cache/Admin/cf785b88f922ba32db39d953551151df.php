				...
				<dl class="row">
					...
					<dd class="opt" id="divComUploadContainer">
						...
						<div id="thumbnails" class="ncap-thumb-list">
							...
							<ul>
								<?php if(($attachment) != ""): if(is_array($attachment)): $i = 0; $__LIST__ = $attachment;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$file): $mod = ($i % 2 );++$i;?><li id="file_<?php echo ($file["scene_id"]); ?>_<?php echo ($file["atta_id"]); ?>">
