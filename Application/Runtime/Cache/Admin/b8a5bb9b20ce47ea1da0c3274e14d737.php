...
<body style="background-color: #FFF; overflow: auto;">
	...
	<div class="page">
		...
		<form id="add_form" method="post">
			...
			<input type="hidden" name="hotspot_id" value="" />
			<input type="hidden" name="scence_id" value="<?php echo ($sid); ?>" />

			<div class="ncap-form-default">
				<dl class="row">
					<dt class="tit">
						<label for="hotspot_name"><em>*</em>热点名称</label>
					</dt>
					<dd class="opt">
						<input type="text" id="hotspot_name" name="hotspot_name" class="input-txt">
						<span class="err"></span>
